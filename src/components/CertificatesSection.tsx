  ...
  return (
    <section id="certificates" className="py-24 relative spider-web-bg">
      <div className="container mx-auto px-6" ref={ref}>
        ...
        {/* Certificates - horizontal scrolling animation */}
        <div className="mb-16">
            ...
            >
              {certificates.map((cert, i) => (
                <motion.div
                  ...
                  className="min-w-[280px] md:min-w-[320px] p-6 rounded-xl bg-card border border-border hover:border-primary/30 transition-all group flex-shrink-0"
                >
